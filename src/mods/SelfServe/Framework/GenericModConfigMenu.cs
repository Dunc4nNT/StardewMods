    ...
    Action save)
{
    public void Register()
    {
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_BeachSection);
        configMenu.AddBoolOption(
            manifest,
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_MountainSection);
        configMenu.AddBoolOption(
            manifest,
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_ForestSection);
        configMenu.AddBoolOption(
            manifest,
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_DesertSection);
        configMenu.AddBoolOption(
            manifest,
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_GingerIslandSection);
        configMenu.AddBoolOption(
            manifest,
        ...
        configMenu.AddSectionTitle(
            manifest,
            I18n.Config_Shops_NightMarketSection);
        configMenu.AddBoolOption(
            manifest,
